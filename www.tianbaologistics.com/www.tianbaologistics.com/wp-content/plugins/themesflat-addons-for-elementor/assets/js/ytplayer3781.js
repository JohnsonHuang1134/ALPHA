    ...
    jQuery.mbYTPlayer = {
        ...
        checkForStart: function(YTPlayer) {
            ...
            if (YTPlayer.opt.addRaster) {
                ...
                var classN = "";
                if (YTPlayer.opt.addRaster == "style-1") {
                    classN = "style-1"
                }
                if (YTPlayer.opt.addRaster == "style-2") {
                    classN = "style-2"
                }
                if (YTPlayer.opt.addRaster == "style-3") {
                    classN = "style-3"
                }
                if (YTPlayer.opt.addRaster == "style-4") {
                    classN = "style-4"
                }
                if (YTPlayer.opt.addRaster == "style-5") {
                    classN = "style-5"
                }
                if (YTPlayer.opt.addRaster == "style-6") {
                    classN = "style-6"
                }
                if (YTPlayer.opt.addRaster == "style-7") {
                    classN = "style-7"
                }
                if (YTPlayer.opt.addRaster == "style-8") {
                    classN = "style-8"
                }
                if (YTPlayer.opt.addRaster == "style-9") {
                    classN = "style-9"
                }
