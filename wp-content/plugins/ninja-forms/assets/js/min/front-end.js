! function() {
    ...
    ! function(n) {
        ...
        function p(e, t) {
            var i, n, r, o, a, l, s, d, f, u, h, g = t && t.split("/"),
                ...
                v = p && p["*"] || {};
            if (e) {
                for (a = (e = e.split("/")).length - 1, c.nodeIdCompat && m.test(e[a]) && (e[a] = e[a].replace(m, "")), "." === e[0].charAt(0) && g && (e = g.slice(0, g.length - 1).concat(e)), f = 0; f < e.length; f++)
        ...
        a = function(e, t) {
            var i, n, r = R(e),
                o = r[0],
                a = t[1];
            return e = r[1], o && (i = b(o = p(o, a))), o ? e = i && i.normalize ? i.normalize(e, (n = a, function(e) {
                return p(e, n)
            })) : p(e, a) : (o = (r = R(e = p(e, a)))[0], e = r[1], o && (i = b(o))), {
                f: o ? o + "!" + e : e,
                n: e,
                pr: o,
                p: i
            ...
            if (p = _(r = r || e), "undefined" === F || "function" === F) {
                for (t = !t.length && i.length ? ["require", "exports", "module"] : t, m = 0; m < t.length; m += 1)
                    if ("require" === (c = (h = a(t[m], p)).f)) w[m] = l.require(e);
                    else if ("exports" === c) w[m] = l.exports(e), R = !0;
                else if ("module" === c) o = w[m] = l.module(e);
                else if (g(s, c) || g(d, c) || g(f, c)) w[m] = b(c);
                else {
                    if (!h.p) throw new Error(e + " missing " + c);
                    h.p.load(h.n, v(r, !0), y(c), {}), w[m] = s[c]
                }
                u = i ? i.apply(s[e], w) : void 0, e && (o && o.exports !== n && o.exports !== s[e] ? s[e] = o.exports : u === n && R || (s[e] = u))
            } else e && (s[e] = i)
        }, e = t = o = function(e, t, i, s, d) {
            if ("string" == typeof e) return l[e] ? l[e](t) : b(a(e, _(t)).f);
            if (!e.splice) {
    ...
    }(), i("../../../node_modules/almond/almond", (function() {})), i("models/fieldErrorModel", [], (function() {
        ...
        var t = Backbone.Collection.extend({
            ...
            initialize: function(e, t) {
                ...
                }), this), nfRadio.channel("fields").reply("get:firstFieldByOrder", this.getFirstFieldByOrder)
            },
            validateFields: function() {
                _.each(this.models, (function(e) {
                    ...
                    } else e.set("clean", !1), nfRadio.channel("submit").trigger("validate:field", e)
                }), this);
        ...
        return Marionette.Object.extend({
            ...
            getField: function(e) {
                ...
                })), void 0 === t && -1 !== String(e).indexOf(".") && (t = nfRadio.channel("field-repeater").request("get:repeaterFieldById", e)), t
            }
        })
        ...
        return Marionette.Object.extend({
            ...
            dateChange: function(e) {
                ...
                if (0 < n.length)
                    if (this.isDateValid(n, r, i)) nfRadio.channel("fields").request("remove:error", i, t);
                    else {
            ...
            dateKeyup: function(e, i, n) {
                ...
                var r = jQuery(e).val(),
                    ...
                    a = i.get("date_format"),
                    l = moment.locale();
                if (moment.locale("ninja-forms"), 0 == r.length) nfRadio.channel("fields").request("remove:error", o, t);
                else if (this.isDateValid(r, a, o) || i.get("clean")) this.isDateValid(r, a, o) && (nfRadio.channel("fields").request("remove:error", o, t), i.addWrapperClass("nf-pass"), i.set("clean", !1));
                else {
                    var s = nfRadio.channel("fields").request("get:field", o),
                        d = nfRadio.channel("app").request("get:form", s.get("formID"));
                    nfRadio.channel("fields").request("add:error", o, t, d.get("settings").changeDateErrorMsg), i.removeWrapperClass("nf-pass")
                }
                moment.locale(l)
            },
            ...
            isDateValid: function(e, t, i) {
                const n = document.querySelector("[name='nf-field-" + i + "']")._flatpickr.parseDate(e, t);
                if (!n) return !1;
                const r = n.getTime();
                if (isNaN(r)) return !1;
                const o = new Date(r);
                return document.querySelector("[name='nf-field-" + i + "']")._flatpickr.formatDate(o, t) === e
            }
        })
        ...
        return Marionette.Object.extend({
            ...
            click: function(e, t) {
                ...
                _.size(i.get("fieldErrors")) > 0 && nfRadio.channel("submit").request("focus:firstInvalidInput", Object.keys(i.get("fieldErrors"))), nfRadio.channel("form-" + t.get("formID")).request("submit", i)
            },
            beforeSubmit: function() {
                this.get("disabled") || (this.set("disabled", !0), nfRadio.channel("form-" + this.get("formID")).trigger("processingLabel", this))
            },
            ...
            processingLabel: function() {
                this.set("oldLabel", this.get("label")), this.set("label", this.get("processing_label")), this.set("disabled", !0), this.trigger("reRender")
            },
        ...
        return Marionette.Object.extend({
            ...
            validateRequired: function(e, t) {
                ...
                var i = jQuery(e).val(),
                    ...
                    r = !0,
                    o = this.getMask(t);
                if (o && i === o && (0 < t.get("errors").length || !t.get("clean")) && (r = !1), String(i).trim() || (r = !1), void 0 !== n) var a = n;
                else a = r;
                this.maybeError(a, t)
            },
            getMask: function(e) {
                ...
                if (void 0 !== t) {
                    switch (t) {
                        case "":
                            break;
                        case "currency":
                            t = nfi18n.currencySymbol;
                            break;
                        case "custom":
                            t = e.get("custom_mask");
                        default:
                            t = (t = (t = t.replace(/9/g, "_")).replace(/a/g, "_")).replace(/\*/g, "_")
                    }
                    return t
                }
            },
        ...
        return Marionette.Object.extend({
            initialize: function() {
                this.listenTo(nfRadio.channel("forms"), "submit:response", this.submitErrors), nfRadio.channel("submit").reply("focus:firstInvalidInput", this.focusFirstInvalidInput)
            },
        ...
        return Marionette.Object.extend({
            ...
            actionSubmit: function(e) {
                if (0 == _.size(e.errors) && void 0 !== e.data.actions && void 0 !== e.data.actions.success_message && "" != e.data.actions.success_message) {
                    ...
                    i.attr("tabindex", "0"), i.attr("aria-live", "assertive"), i.attr("aria-label", l), i.html(e.data.actions.success_message).show(), i.focus();
                    var n = i.offset().top,
        ...
        return Marionette.Object.extend({
            ...
            localeDecodeEquation: function(e) {
                ...
                return (e = (e = e.replace(/\s/g, "")).replace(/&nbsp;/g, "")).split("").forEach((function(e) {
                    n.test(e) ? i += e : (0 < i.length && (t += o.numberDecoder(i), i = ""), t += e)
        ...
        return Marionette.Object.extend({
            initialize: function() {
                this.listenTo(nfRadio.channel("date"), "init:model", this.initModel), this.listenTo(nfRadio.channel("date"), "render:view", this.initDatepicker)
            },
            ...
            maybeRenderAMPM: function() {
                if (void 0 !== this.hours_24 && 1 != this.hours_24) return `<div style="float:left;" class="time-wrap"><select id="ampm-select" class="ampm extra" aria-label="am-pm-select" ${1==this.required?'aria-required="true" required':""}><option value="am">AM</option><option value="pm">PM</option></select></div>`
            },
            initDatepicker: function(e) {
                ...
                var n = {
                    onReady: (e, i, n) => {
                        n.altInput.setAttribute("aria-labelledby", jQuery(t).attr("aria-labelledby")), n.altInput.setAttribute("aria-invalid", !1)
                    },
                    dateFormat: i,
                    altFormat: i,
                    altInput: !0,
                ...
                void 0 !== o && (n = o);
                var a = flatpickr(t, n);
                1 == e.model.get("date_default") && (a.defaultDate = new Date, a.setDate(a.defaultDate), e.model.set("value", a.defaultDate)), nfRadio.channel("pikaday-bc").trigger("init", a, e.model, e), nfRadio.channel("flatpickr").trigger("init", a, e.model, e)
            },
            beforeSubmit: function(e) {
                if (_.isObject(this.model.get("value"))) {
                    const e = this.el.id.replace("-wrap", ""),
                        t = this.el.querySelector("#" + e).value;
            ...
            convertDateFormat: function(e) {
                !e && this.model && (e = this.model.get("date_format")), e || (e = "default");
                const t = {
                    "MM/DD/YYYY": "m/d/Y",
                    "MM-DD-YYYY": "m-d-Y",
                    "MM.DD.YYYY": "m.d.Y",
        ...
        return Marionette.Object.extend({
            ...
            initRecaptcha: function(e) {
                ...
                this.processRecaptcha(t, e), setInterval(this.processRecaptcha, 11e4, t, e)
            },
            processRecaptcha: function(e, t) {
                try {
                    nfRadio.channel("form-" + e).trigger("disable:submit", t), grecaptcha.ready((function() {
                        grecaptcha.execute(t.get("site_key"), {
                            action: "register"
                        }).then((function(i) {
                            t.set("value", i), nfRadio.channel("form-" + e).trigger("enable:submit", t)
                        }))
                    }))
                } catch (e) {
                    jQuery(document).on("nfFormReady", (e => {
                        ...
                        })), nfRadio.channel("fields").request("add:error", i, "recaptcha-v3-missing", t.collection.options.formModel.get("settings").recaptchaConsentMissing), this.nf_build_default_consent_action(t, n.services, i, e)
                    }))
                }
            },
                    ...
                    if (-1 === n.indexOf(e)) {
                        ...
                        if (void 0 !== t) {
                            if (-1 === ["submit", "html", "hidden", "password", "passwordconfirm", "divider", "hr", "note", "unknown", "button", "confirm", "creditcard", "creditcardcvc", "creditcardexpiration", "creditcardfullname", "creditcardnumber", "creditcardzip", "recaptcha", "recaptcha_v3"].indexOf(t.get("type")) && t.getValue().toString().length > 0) {
                                ...
                                i += "<p>" + t.get("label") + " " + r + " : " + t.getValue() + "</p>", n.push(e)
                            }
                        }
                    }
                })), i
        ...
        return Marionette.Object.extend({
            ...
            initHelpText: function(e) {
                jQuery(e.el).find(".nf-help").each((function() {
                    var e = jQuery(this).jBox("Tooltip", {
                        theme: "TooltipBorder",
        ...
        return Marionette.ItemView.extend({
            ...
            onRender: function() {
                if (this.$el = this.$el.children(), this.$el.unwrap(), this.setElement(this.$el), void 0 !== this.model.get("mask") && "" != String(this.model.get("mask")).trim()) {
            ...
            templateHelpers: function() {
                ...
                return {
                    ...
                    renderPlaceholder: function() {
                        ...
                        return void 0 !== this.customPlaceholder && (e = this.customPlaceholder(e)), "" != String(e).trim() ? 'placeholder="' + _.escape(e) + '"' : ""
                    },
                    renderWrapClass: function() {
                        var e = "field-wrap " + this.type + "-wrap";
                        return this.type !== this.parentType && (e = e + " " + this.parentType + "-wrap"), void 0 !== this.old_classname && 0 < String(this.old_classname).trim().length && (e += " " + this.old_classname + "-wrap"), "undefined" != typeof customWrapClass && (e = customWrapClass(e)), e
                    },
                    renderClasses: function() {
                        var e = this.classes;
                        return this.error ? e += " nf-error" : e = e.replace("nf-error", ""), void 0 !== this.element_class && 0 < String(this.element_class).trim().length && (e += " " + this.element_class), void 0 !== this.customClasses && (e = this.customClasses(e)), e
                    },
                    ...
                    maybeDisableAutocomplete: function() {
                        if (1 == this.disable_browser_autocomplete) return 'autocomplete="off"';
                    ...
                    maybeRenderHelp: function() {
                        ...
                        var t = !1;
                        if ((0 != String(jQuery(e).text()).trim().length || 0 < jQuery(e).find("img").length) && (t = !0), void 0 !== this.help_text && t) {
                            var i = document.createElement("span");
                            i.classList.add("fa", "fa-info-circle", "nf-help"), i.setAttribute("data-text", this.getHelpText()), i.setAttribute("tabindex", "0"), i.setAttribute("aria-describedby", "hidden-help-text-" + this.id);
                            var n = document.createElement("span");
                            return n.textContent = this.help_text.replace(/<\/?[^>]+(>|$)/g, "").trim(), n.id = "hidden-help-text-" + this.id, n.classList.add("nf-sr-only"), n.setAttribute("role", "tooltip"), i.appendChild(n), i.outerHTML
                        }
                        return ""
                    },
        ...
        return Marionette.ItemView.extend({
            ...
            onRender: function() {
                ...
                if (this.errorCollectionView = new e({
                    ...
                    }), 0 < this.model.get("errors").length && this.errorCollectionView.render(), void 0 !== this.model.get("input_limit") && "" != String(this.model.get("input_limit")).trim()) {
                    var n = jQuery(this.el).children(".nf-input-limit");
                    this.inputLimitView = new t({
                        el: n,
                        model: this.model
                    }), n.attr("aria-live", "polite"), n.attr("role", "status"), n.attr("aria-relevant", "additions"), n.attr("aria-atomic", !0)
                }
            },
            ...
            templateHelpers: function() {
                return {
                    renderContainerClass: function() {
                        ...
                        return void 0 !== this.desc_pos && (e += "desc-" + this.desc_pos + " "), void 0 !== this.container_class && 0 < String(this.container_class).trim().length && (e += this.container_class + " "), this.type !== this.parentType && (e += " " + this.parentType + "-container"), e
                    }
                }
            }
        })
        ...
        return Marionette.LayoutView.extend({
            ...
            initialize: function() {
                this.collection = this.model.get("sets"), this.listenTo(nfRadio.channel("field-repeater"), "rerender:fieldsets", this.render)
            },
            onRender: function() {
                ...
                jQuery.ajax({
                    ...
                    error: function(t, i, n) {
                        ...
                        try {
                            ...
                            console.log("Parse Error: " + t.responseText), nfRadio.channel("form-" + e.get("id")).request("add:error", "parse-response-ERROR", n)
                        }
                    }
                })
            }
    ...
    i("models/fieldRepeaterSetModel", [], (function() {
            ...
            setAllRepeatersValues: function() {
                ...
                e.length > 0 && _.each(e, (function(e) {
                    ...
                    if (t.length > 0) {
                        ...
                        })), i.set("isUpdated", !1), nfRadio.channel("nfAdmin").request("update:field", i, e)
                    }
                }))
            }
        })
        ...
        return Backbone.Collection.extend({
            model: e,
            initialize: function(e, t) {
                this.options = t, this.listenTo(nfRadio.channel("field-repeater"), "sort:fieldsets", this.sortIDs), this.listenTo(nfRadio.channel("field-repeater"), "remove:fieldset", this.removeSet), this.listenTo(nfRadio.channel("field-repeater"), "add:fieldset", this.addSet), nfRadio.channel("field-repeater").reply("get:fieldsets", this.getFieldSets, this)
            },
            addSet: function(e = !1) {
                if (e) {
            ...
            removeSet: function(e) {
                this.removeRequiredFieldsErrors(e);
                const t = e.repeaterFieldModel.get("formID"),
                    i = e.repeaterFieldModel.get("id"),
                    r = n.find((e => e.id === i && e.form === t));
                r && (_.each(r.fields, ((t, i) => {
                    void 0 !== t && _.each(e.get("fields").models, (e => {
                        const n = void 0 !== t.id ? t.id : t.get("id");
                        e.id === n && r.fields.splice(i, 1)
                    }))
                })), nfRadio.channel("field-repeater").trigger("set:repeaterModels")), this.remove(e), e.destroy(), this.sortIDs(), nfRadio.channel("field-repeater").trigger("set:value")
            },
            removeRequiredFieldsErrors: function(e) {
                let t = e.get("fields");
                _.each(t.models, (function(e) {
                    nfRadio.channel("fields").request("remove:error", e.get("id"), "required-error")
                }))
            },
    ...
    })), i("controllers/loadControllers", ["controllers/formData", "controllers/fieldError", "controllers/changeField", "controllers/changeEmail", "controllers/changeDate", "controllers/fieldCheckbox", "controllers/fieldCheckboxList", "controllers/fieldImageList", "controllers/fieldRadio", "controllers/fieldNumber", "controllers/mirrorField", "controllers/confirmField", "controllers/updateFieldModel", "controllers/submitButton", "controllers/submitDebug", "controllers/getFormErrors", "controllers/validateRequired", "controllers/submitError", "controllers/actionRedirect", "controllers/actionSuccess", "controllers/fieldSelect", "controllers/coreSubmitResponse", "controllers/fieldProduct", "controllers/fieldTotal", "controllers/fieldQuantity", "controllers/calculations", "controllers/dateBackwardsCompat", "controllers/fieldDate", "controllers/fieldRecaptcha", "controllers/fieldRecaptchaV3", "controllers/fieldHTML", "controllers/helpText", "controllers/fieldTextbox", "controllers/fieldTextareaRTE", "controllers/fieldStarRating", "controllers/fieldTerms", "controllers/formContentFilters", "controllers/loadViews", "controllers/formErrors", "controllers/submit", "controllers/defaultFilters", "controllers/uniqueFieldError", "controllers/fieldRepeater"], (function(e, t, i, n, r, o, a, l, s, d, c, f, u, h, m, g, p, v, y, b, R, _, w, F, x, M, C, k, T, E, j, q, D, V, O, I, Q, S, L, A, N, z, B) {
        return Marionette.Object.extend({
            initialize: function() {
                new S, new L, new A, new o, new a, new l, new s, new d, new R, new w, new F, new x, new T, new E, new j, new q, new D, new V, new O, new I, new Q, new z, new B, new t, new i, new n, new r, new c, new f, new u, new h, new m, new g, new p, new v, new y, new b, new _, new M, new N, new C, new k, new e
            }
        })
    ...
    i("../nfLocaleConverter", (function() {})), void 0 !== nfInlineVars.nfForms && (window.nfForms = nfInlineVars.nfForms),
        function(e) {
            var t = e.fn.val;
            e.fn.val = function() {
                var i;
